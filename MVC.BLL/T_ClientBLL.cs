...
namespace MVC.BLL
{
    public partial class T_ClientBLL : BaseBLL<T_Client>, IT_ClientBLL
    {
        /// <summary>
        /// 实现这个对象，把类型传给基类
        /// </summary>
        /// <returns></returns>
        public override BaseDAL<T_Client> GetDAL()
        {
            return new T_ClientDAL();
        }
        ...
        public int EditData(int id, object model)
        {
            ...
            T_Client newdata = (T_Client)Helper.Method.CopyModel(model, data);
        ...
        /// <param name="Orders">排序字典key:排序的字段,value:asc升序/desc降序</param> 
        /// <returns></returns>
        public List<T_ClientModel> Filter(Expression<Func<T_ClientModel, bool>> LambdaWhere = null, Dictionary<string, string> Orders = null)
        {
            List<T_ClientModel> result = new List<T_ClientModel>();
            MyVisitor<T_ClientModel, T_Client> visitor = new MyVisitor<T_ClientModel, T_Client>();
